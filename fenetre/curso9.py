...
class Editor(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title('GlobalMentororing.com.mx -Editor de Texto')
    ...
    def _crear_componentes(self):
        frame_botones = tk.LabelFrame(self, relief=tk.RAISED,bd=2)
    ...
    def _guardar_como(self):
        # salvamos el archivo  actual como nuevo archivo
        ...
        with open(self.archivo, 'w') as archivo:
            ...
            self.title(f'Editor Texto - {self.archivo.name}')
            # Indicamos que hemos abierto un archibo
