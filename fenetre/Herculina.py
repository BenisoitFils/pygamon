...
def menu():
    main_menu = Menu(ventana)
    submenu_operation = Menu(main_menu, tearoff=0)
    submenu_operation.add_command(label='Sumar')
    submenu_operation.add_command(label='Restar')
    submenu_operation.add_command(label='Multiplicar')
    submenu_operation.add_command(label='Dividir')
    main_menu.add_cascade(menu=submenu_operation, label='Operation')
    submenu_mas = Menu(main_menu, tearoff=False)
    submenu_mas.add_command(label='Numero par o No')
    submenu_mas.add_command(label='Multiplo 3 o 5')
    submenu_mas.add_command(label='Multiplo 3 y 5')
    submenu_mas.add_command(label='Factorial')
    submenu_mas.add_command(label='Salir', command=salir)
    main_menu.add_cascade(menu=submenu_mas, label='Mas')
    ventana.config(menu=main_menu)



l= tk.Label(ventana, text='bienvenido en el programa HERCULES\r\n MENÚ: \r\n1. Sumar 2. Restar 3. Multiplicar '
                      '4. Dividir 5. Numero es par o impar '
                      '6. Número es multiplo de 3 o 5\r\n'
                      '7. Número es multiplo de 3 y 5 '
                      '8. Factorial de número '
